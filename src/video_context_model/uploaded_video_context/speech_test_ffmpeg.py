...
def log_speech_transcription(text, is_final=True, log_file="logs/speech_log.txt"):
    """Log speech transcriptions with timestamp"""
...
class SpeechProcessor:
    ...
    def __init__(self, log_file="logs/speech_log.txt"):
        ...
        self.transcription_cooldown = 0.5  # Minimum time between transcriptions
    ...
    def process_speech(self):
        """Process speech with context categorization"""
    ...
    def categorize_speech(self, text):
        """Categorize speech into different types"""
    ...
    def log_speech_context(self, text, context):
        """Log speech with context information"""
        timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S.%f")[:-3]
